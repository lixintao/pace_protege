...
public interface OWLOntology extends OWLObject, HasAxioms, HasLogicalAxioms,
        ...
        HasImportsClosure, HasContainsEntityInSignature,
        HasGetEntitiesInSignature, HasOntologyID {
     ...
     * not loaded for whatever reason.
     * 
     ...
     * or not this ontology is empty (i.e. contains no axioms, the isEmpty
     * method is preferred over getAxioms().isEmpty(). )
     * 
     ...
     */
    Set<OWLEntity>
            getEntitiesInSignature(IRI iri, boolean includeImportsClosure);
